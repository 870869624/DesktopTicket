...
- 调节透明度（20%~100%），防止遮挡桌面
- 自由调整便签大小
- 右键菜单快速操作（编辑/置顶/透明度/隐藏/删除）
- 便签内容可选中复制
- 系统托盘图标，关闭设置窗口后可通过托盘重新打开
- 设置窗口位置和大小自动保存
- 便签拖出屏幕后自动回到可见区域
- 新建便签自动错开位置，避免重叠
- 数据本地持久化存储
...
4. 勾选 **固定位置** 可禁止拖动便签
5. 勾选 **置顶显示** 便签始终在最上层（右键菜单可切换）
6. 点击 **保存** 保存设置
7. 点击 **显示到桌面** 便签会出现在桌面上
8. 桌面便签可拖动（未固定时）、可调整大小
9. 便签内容可直接选中复制
10. 右键桌面便签可：编辑 / 置顶切换 / 透明度 / 隐藏 / 删除
11. 关闭设置窗口后，通过系统托盘图标可重新打开
